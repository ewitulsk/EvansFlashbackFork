                    ...
                    if (keybind.isForceScrollKey()) {
                        ...
                        for (int i = 0; i < ImGuiMouseButton.COUNT; i++) {
                            if (ImGui.isMouseClicked(i)) {
                                ...
                                // Negative keybind keys encode an SDL mouse button as -button-1;
                                // ImGui button order is left/right/middle, SDL is left/middle/right
                                int sdlButton = i == ImGuiMouseButton.Right ? 3 : i == ImGuiMouseButton.Middle ? 2 : i + 1;
                                keybind.set(-sdlButton-1, shiftDown,
                                    InputQuirks.REPLACE_CTRL_KEY_WITH_CMD_KEY ? superDown : ctrlDown,
                                    altDown,
                                    InputQuirks.REPLACE_CTRL_KEY_WITH_CMD_KEY ? ctrlDown : superDown);
                            }
